    ...
    images: [
      {
        title: "title1",
        path: "/thumb1.jpg",
        url: "https://ig.bluehouseng.com/",
        projectName: "Infinity Gem",
      },
      {
        title: "title2",
        path: "/thumb2.jpg",
        url: "https://www.packmyload.com/",
        projectName: "Pack My Load",
      },
      {
        title: "title3",
        path: "/thumb3.jpg",
        url: "https://www.bluehouseng.com/",
        projectName: "Bluehouse Site",
      },
      {
        title: "title4",
        path: "/thumb4.jpg",
        url: "https://www.plugbay.com/en",
        projectName: "Plugbay Business Listing Site",
      },
    ],
  },
  {
    images: [
      {
        title: "title5",
        path: "/thumb4.jpg",
        url: "https://www.marbstores.com/",
        projectName: "Marb Stores",
      },
      {
        title: "title6",
        path: "/thumb1.jpg",
              ...
              {slide.images.map((image, imgIndex) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 inset-0 flex items-center justify-center text-white text-center opacity-0 group-hover:opacity-100 transition-all duration-700 p-2 sm:p-4">
                    ...
                    <div className="flex flex-row space-x-2 items-center">
                      {image.projectName.split(" ").map((word, wordIndex) => (
                        <a
                          ...
                          className={`text-sm sm:text-xl font-bold transition-transform duration-500 delay-${
                            wordIndex * 300
                    ...
                    {/* Title Part 2 */}
                    <div
                      className={`text-[13px] sm:text-lg tracking-[0.2em] transition-transform duration-500 delay-${
                        image.projectName.split(" ").length * 300
                      } group-hover:translate-y-0 translate-y-full`}
                    >
                      {/* title part 2 */}
                    </div>
                    {/* Icon */}
                    <div
                      className={`text-lg sm:text-3xl transition-transform duration-500 delay-${
                        (image.projectName.split(" ").length + 1) * 300
                      } group-hover:translate-y-0 translate-y-full`}
                    >
                      {/* icon */}
                      <div
