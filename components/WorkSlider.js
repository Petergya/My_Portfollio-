...
//         .custom-pagination {
//           position: absolute;
//           bottom: -20px; /* Adjust this value to position it just below the Swiper */
//           left: 0;
//           width: 100%;
//           display: flex;
//           justify-content: center;
//            margin-top: 32px; /* Reduced space for larger screens */
...
//           .custom-pagination {
//             margin-top: -48px; /* Reduced space from the Swiper on larger screens */
//           }
//       `}</style>
//     </div>
//   );
  ...
  return (
    <div className="relative">
      ...
      <style jsx>{`
        .custom-pagination {
          position: absolute;
          bottom: -25px; /* Adjust this value to position it just below the Swiper */
          left: 50%;
